...
{
    internal class UserConfiguration : IEntityTypeConfiguration<Domain.User.Entites.User>
    {
        public void Configure(EntityTypeBuilder<Domain.User.Entites.User> builder)
        {
